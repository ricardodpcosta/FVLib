...
#undef __fvl_mesh__
#undef __fvl_type__
#undef __fvl_num_derivs__
#undef __fvl_num_steps__
#define __fvl_model__ t
#define __fvl_mesh__ mesh
#define __fvl_num_steps__ __fvl_max_num_steps__
#define __fvl_type__ fvl_field2d_cellmeansfield
#include "fvl_createscalarmodel2d_hdr.f"
...
#define __fvl_num_steps__ 1
#define __fvl_type__ fvl_field2d_cellmeansfield
#include "fvl_createvectormodel2d_hdr.f"
